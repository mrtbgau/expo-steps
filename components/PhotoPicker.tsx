...
// Dans votre screen Tab, ajoutez ceci dans la BottomModal :

/*
Ajoutez cette ligne dans vos imports :
import ImagePickerComponent from '@/components/ImagePickerComponent';

Et dans la BottomModal, après les dates :
  ...
  <View style={styles.modalContent}>
    ...
    <View style={styles.dateInputsRow}>
      <View style={styles.dateInput}>
        <Input placeholder="Date de début" variant="input" type="date" />
      </View>
      <View style={styles.dateInput}>
        <Input placeholder="Date de fin" variant="input" type="date" />
      </View>
    </View>
